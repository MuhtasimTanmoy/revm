...
## [19.2.0](https://github.com/MuhtasimTanmoy/revm/compare/revm-interpreter-v19.1.0...revm-interpreter-v19.2.0) - 2025-05-20

### Added

- expose Gas::memory field ([#2512](https://github.com/MuhtasimTanmoy/revm/pull/2512))
- added CallInput::bytes<CTX>(ctx: &CTX) -> Bytes {} function ([#2507](https://github.com/MuhtasimTanmoy/revm/pull/2507))

### Other

- make crates.io version badge clickable ([#2526](https://github.com/MuhtasimTanmoy/revm/pull/2526))
- fix clippy ([#2523](https://github.com/MuhtasimTanmoy/revm/pull/2523))
