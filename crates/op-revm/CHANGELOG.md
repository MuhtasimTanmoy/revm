...
## [5.1.0](https://github.com/MuhtasimTanmoy/revm/compare/op-revm-v5.0.0...op-revm-v5.1.0) - 2025-05-26

### Added

- transact multi tx ([#2517](https://github.com/MuhtasimTanmoy/revm/pull/2517))

### Other

- *(test)* preserve order of fields in json fixtures ([#2541](https://github.com/MuhtasimTanmoy/revm/pull/2541))
